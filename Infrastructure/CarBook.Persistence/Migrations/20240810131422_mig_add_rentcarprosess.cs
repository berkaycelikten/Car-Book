...
{
    /// <inheritdoc />
    public partial class mig_add_rentcarprosess : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "RentACarProsses",
                columns: table => new
                {
                    RentACarprossesID = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RentACarProsses", x => x.RentACarprossesID);
                    table.ForeignKey(
                        name: "FK_RentACarProsses_Cars_CarID",
                        column: x => x.CarID,
                        principalTable: "Cars",
                        principalColumn: "CarID",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_RentACarProsses_Customers_CustomerID",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RentACarProsses_CarID",
                table: "RentACarProsses",
                column: "CarID");

            migrationBuilder.CreateIndex(
                name: "IX_RentACarProsses_CustomerID",
                table: "RentACarProsses",
                column: "CustomerID");
        }
