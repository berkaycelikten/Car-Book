    ...
    public class AdminStatisticsController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            if (responseMessage5.IsSuccessStatusCode)
            {
                ...
                var values5 = JsonConvert.DeserializeObject<ResultStatisticksDto>(jsonData5);
            ...
            if (responseMessage6.IsSuccessStatusCode)
            {
                ...
                var values6 = JsonConvert.DeserializeObject<ResultStatisticksDto>(jsonData6);
            ...
            if (responseMessage7.IsSuccessStatusCode)
            {
                ...
                var values7 = JsonConvert.DeserializeObject<ResultStatisticksDto>(jsonData7);
            ...
            if (responseMessage8.IsSuccessStatusCode)
            {
                ...
                var values8 = JsonConvert.DeserializeObject<ResultStatisticksDto>(jsonData8);
            ...
            #region İstatistik9
            var responseMessage9 = await client.GetAsync("https://localhost:7265/api/Statistics/GetCarCountByTransmissionIsAuto");
            if (responseMessage9.IsSuccessStatusCode)
            {
                int carCountByTranmissionIsAutoRandom = random.Next(0, 101);
                var jsonData9 = await responseMessage9.Content.ReadAsStringAsync();
                var values9 = JsonConvert.DeserializeObject<ResultStatisticksDto>(jsonData9);
            ...
            if (responseMessage10.IsSuccessStatusCode)
            {
                ...
                var values10 = JsonConvert.DeserializeObject<ResultStatisticksDto>(jsonData10);
            ...
            if (responseMessage11.IsSuccessStatusCode)
            {
                ...
                var values11 = JsonConvert.DeserializeObject<ResultStatisticksDto>(jsonData11);
            ...
            #region İstatistik12
            var responseMessage12 = await client.GetAsync("https://localhost:7265/api/Statistics/GetCarCountByKmSmallerThan1000");
            if (responseMessage12.IsSuccessStatusCode)
            {
                int carCountByKmSmallerThen1000Random = random.Next(0, 101);
                var jsonData12 = await responseMessage12.Content.ReadAsStringAsync();
                var values12 = JsonConvert.DeserializeObject<ResultStatisticksDto>(jsonData12);
            ...
            if (responseMessage13.IsSuccessStatusCode)
            {
                ...
                var values13 = JsonConvert.DeserializeObject<ResultStatisticksDto>(jsonData13);
            ...
            if (responseMessage14.IsSuccessStatusCode)
            {
                ...
                var values14 = JsonConvert.DeserializeObject<ResultStatisticksDto>(jsonData14);
            ...
            if (responseMessage15.IsSuccessStatusCode)
            {
                ...
                var values15 = JsonConvert.DeserializeObject<ResultStatisticksDto>(jsonData15);
            ...
            if (responseMessage16.IsSuccessStatusCode)
            {
                ...
                var values16 = JsonConvert.DeserializeObject<ResultStatisticksDto>(jsonData16);
